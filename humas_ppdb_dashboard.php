...
<body id="bodytemplate" class="bg-gradient-primary">
    ...
    if (isset($_POST['input'])) {
        ...
        $problem   = $_POST['kendala_humas_ppdb']; //done
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="p-5">
                                    <form method="POST" enctype="multipart/form-data" action="humas_ppdb_dashboard.php">
                                        <div class="container">
                                            <div class="row">
                                                <div class="">
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <input type="hidden" name="departemen" value="humas_ppdb" id="departemen" />
                                                        ...
                                                        <div class="form-input mb-2">
                                                            ...
                                                            <select class="form-control " name="kendala_humas_ppdb" id="kendala_humas_ppdb" required>
