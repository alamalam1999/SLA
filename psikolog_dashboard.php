...
<body id="bodytemplate" class="bg-gradient-primary">
    ...
    if (isset($_POST['input'])) {
        ...
        $problem   = $_POST['kendala_psikolog']; //done
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="p-5">
                                    <form method="POST" enctype="multipart/form-data" action="psikolog_dashboard.php">
                                        <div class="container">
                                            <div class="row">
                                                <div class="">
                                                    ...
                                                    <div class="container">
                                                        ...
                                                        <div class="form-input mb-2">
                                                            ...
                                                            <select class="form-control " name="kendala_psikolog" id="kendala_psikolog" required>
