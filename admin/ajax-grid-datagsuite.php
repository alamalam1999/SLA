...
while ($row = mysqli_fetch_array($query)) {  // preparing an array
	...
	$nestedData[] = '<td><center>
                     <a href="edit-tiket-gsuite.php?id=' . $row['id_tiket'] . '" style="color:#eee;"  data-toggle="tooltip" title="Edit" class="btn btn-warning">Edit</a>
				     <a href="tiketgsuite.php?aksi=delete&id=' . $row['id_tiket'] . '"  data-toggle="tooltip" title="Delete" onclick="return confirm(\'Anda yakin akan menghapus data ' . $row['id_tiket'] . '?\')" class="btn btn-danger">Delete</a>
	                 </center></td>';
